  ...
  <div class="panel panel-default">
        ...
        <table class="table table-hover b-t b-light">
            ...
            <tr>
                ...
                <td style="color:black">{{$brand_pro->brand_name}}</td>
                <td style="color:black"><span class="text-ellipsis">{{$brand_pro->brand_des}}</span></td>
                ...
                <td style="color:black">
                    ...
                    <span></span>
                    <a href="{{URL::to('/delete-brand-product/'.$brand_pro->brand_id)}}" onclick="return confirm('Bạn chắc chắn muốn xóa?')"  ui-toggle-class="">
